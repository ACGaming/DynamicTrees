...
public abstract class BlockBranch extends Block implements ITreePart, IFutureBreakable {
	 ...
	 * @param rapid  If true then unsupported branch rot will occur regardless of chance value. This will also rot the
	 *               entire unsupported branch at once. True if this rot is happening under a generation scenario as
	 *               opposed to natural tree updates
	...
	/**
	 * This is a copy of Entity.rayTrace which is client side only.  There's no reason for this function to be client
	 * side only as all of it's calls are client/server compatible.
	 *
	 * @param entity
